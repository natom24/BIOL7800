...
The effective reproductive number ($R_t$) was calculated using basic reproductive values($R_0$) for each county predicted in a previous studies [@ives_estimating_2021]. Using previous models and calculations of $R_0$, the formula
