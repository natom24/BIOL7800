...
Indexing by NA returns NA 5 times. Since you are indexing by an unknown element, you are instructing R to retrieve an element it can not recognize, causing it to print NA.
