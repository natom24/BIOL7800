...
\caption{Total cases divided by the total population}\label{fig:fig1}
\end{figure}
...
\textbf{No - or \_ in the caption ref.} No space at the end of this line! \textbf{No - or \_ in the caption ref.} No space at the end of this line!
...
\caption{(ref:captionFig3)}\label{fig:fig3}
\end{figure}
...
\caption{\textbf{No - or \_ in the caption ref.} No space at the end of this line!}\label{fig:fig5}
\end{figure}
...
\caption{\textbf{No - or \_ in the caption ref.} No space at the end of this line!}\label{fig:fig6}
\end{figure}
