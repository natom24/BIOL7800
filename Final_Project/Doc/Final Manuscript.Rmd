...
(ref:captionfig5) **No - or _ in the caption ref.** No space at the end of this line!

```{r fig5, fig.width=7, fig.asp=1, fig.cap="(ref:captionfig5)"}
print(map_rt_cur)
```

(ref:captionfig6) **No - or _ in the caption ref.** No space at the end of this line!
