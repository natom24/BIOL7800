...
The effective reproductive number ($R_t$) was calculated using basic reproductive values($R_0$) for each county predicted in a previous studies (Figure \@ref(fig:fig7)) [@ives_estimating_2021] . Using previous models and calculations of $R_0$, the formula
...
(ref:captionfig7) **No - or _ in the caption ref.** No space at the end of this line!

```{r fig7, fig.width=7, fig.asp=1, fig.cap="(ref:captionfig7)"}
print(map_rt_cur)
```

(ref:captionfig8) **No - or _ in the caption ref.** No space at the end of this line!

```{r fig8, fig.width=7, fig.asp=1, fig.cap="(ref:captionfig8)"}
print(map_rt_omeg)
```
