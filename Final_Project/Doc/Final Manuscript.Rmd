---
title: "County Level Predictors for Covid-19 Prevalence During the Introduction of Omicron"
...
With changes in population density and spatial spread, the basic reproductive number, $R_0$, should change as a result. The basic reproductive number represents the number of predicted infections that can result from one infection [@delamater_complexity_2019]. While studies have already looked into how $R_0$ changes by county, no recent studies have looked at the effective reproductive number on a county level [@ives_estimating_2021]. More importantly, not much is yet known about the new Omicron variant first introduced into the US on December 1, 2021. The Omicron variant is predicted to be more infectious than previous variants of Covid-19 and is predicted to be more resistant to the vaccines we currently have available [@cdc_omicron_2021]. The reproductive number of the Omicron variant is not calculable at such a low prevalence due to the lack of data. However, predictions on how the new variant will spread provide vital information on preventing new infections and reducing overall mortality. 
